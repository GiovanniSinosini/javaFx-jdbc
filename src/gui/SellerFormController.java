...
public class SellerFormController implements Initializable {
	...
	private DepartmentService departmentService; // create dependency with DepartmentService

	private List<DataChangeListener> dataChangeListeners = new ArrayList<>(); // list for those interested (objects) in
																				// an event
	...
	private Seller getFormData() { // get the content of textfields to instantiate a new object(department)
		...
		if (dpBirthDate.getValue() == null) {
			...
			Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault())); // get value from datePicker
	...
	public void updateFormData() { // take the contents of the text fields to assign to the object - in this case:
									// Seller object
		if (entity == null) {
			throw new IllegalStateException("Entity was null");
		}
	...
	public void loadAssociatedObjects() {
		...
		List<Department> list = departmentService.findAll(); // load department from database
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		labelErrorName.setText((fields.contains("name") ? errors.get("name") : ""));  // checks if there is this error name in the collection
