...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	public void setDepartmentService(DepartmentService service) { // connect DepartmentService with DepartmentController
	...
	private void initializeNodes() {
		...
		tableColumnName.setCellValueFactory(new PropertyValueFactory<>("name")); // start column behavior - standard
																					// command
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) { // to instantiate the dialog
